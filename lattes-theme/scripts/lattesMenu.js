let lattesMenu = {
    ...
    init : () => {
        lattesMenu.header = document.getElementById("lattesHeader");
        lattesMenu.burger = document.getElementById("lattesBurger");
        lattesMenu.nav = document.getElementById("lattesNav");
        lattesMenu.menu = document.querySelectorAll(".lattesNavArea_nav>.menu-item");
    ...
    handleDisplaySubNav : (e) => {
        ...
        while(!target.classList.contains("menu-item")){
        ...
        for(let menu of lattesMenu.menu){
            ...
            if(menu.querySelector("ul") && menu !==target){
                menu.querySelector("ul").classList.remove("sub-menu--display");                
            }
        }
        ...
        if(target.querySelector("ul")){           
            target.querySelector("ul").classList.toggle("sub-menu--display");
        }
    }
}
